...
# Load TCGA-WGS data - update this path to your TCGA data location
# Download from: https://portal.gdc.cancer.gov/
tcga_data_path <- "path/to/tcga/final_consensus_passonly.snv_mnv_indel.tcga.controlled.maf"
d <- fread(tcga_data_path)
...
fwrite(d.prepared, "input/TCGA-WGS_deletions_for_delmh.tsv", sep = "\t")
